...
//     <div className="glass-card info-card p-4 mb-4">
...
//           <h6>{project.created_by_name}</h6>
//         </div>
//       </div>

//     </div>

//     <div className="glass-card stats-card p-4">
...
//             <i className="bi bi-list-task text-info"></i>
...
const ProjectDetails = () => {
  ...
  return (
    <motion.div
      className="container-fluid project-details-page"
      initial={{ opacity: 0, y: 20 }}
      animate={{ opacity: 1, y: 0 }}
      transition={{ duration: 0.4 }}
    >
        ...
        <div className="col-lg-8">
          ...
          <div className="glass-card p-4 mb-4">
            ...
            <div className="d-flex justify-content-between align-items-center">
              ...
              <span
                className={`badge ${
                  badgeColor[project.status] || "bg-secondary"
                }`}
              >
                {project.status}
              </span>
